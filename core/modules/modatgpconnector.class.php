...
/**
 * 	\defgroup   atgpconnector     Module atgpconnector
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/atgpconnector/core/modules directory.
 *  \file       htdocs/atgpconnector/core/modules/modatgpconnector.class.php
 *  \ingroup    atgpconnector
 *  \brief      Description and activation file for module atgpconnector
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module atgpconnector
 */
class modatgpconnector extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104068; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'atgpconnector';
		...
		// for default path (eg: /atgpconnector/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /atgpconnector/core/modules/barcode)
		// for specific css file (eg: /atgpconnector/css/atgpconnector.css.php)
		...
		//							'css' => array('/atgpconnector/css/atgpconnector.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/atgpconnector/js/atgpconnector.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		$this->langfiles = array("atgpconnector@atgpconnector");
        ...
        //                              'objecttype:+tabname2:Title2:atgpconnector@atgpconnector:$user->rights->othermodule->read:/atgpconnector/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        // Dictionaries
	    if (! isset($conf->atgpconnector->enabled))
        {
        ...
        $this->dictionaries=array(
            ...
            'tabcond'=>array($conf->atgpconnector->enabled,$conf->atgpconnector->enabled,$conf->atgpconnector->enabled)												// Condition to show each dictionary
        );
        */
...
/*
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'atgpconnector_read';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		...
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'atgpconnector_write';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=atgpconnector',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'atgpconnector top menu',
		//							'mainmenu'=>'atgpconnector',
		//							'leftmenu'=>'atgpconnector_left',			// This is the name of left menu for the next entries
		//							'url'=>'/atgpconnector/pagetop.php',
		//							'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->atgpconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->atgpconnector->enabled' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->atgpconnector->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
		//
		// Example to declare a Left Menu entry into an existing Top menu entry:
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=atgpconnector,fk_leftmenu=atgpconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'atgpconnector left menu',
		//							'mainmenu'=>'atgpconnector',
		//							'leftmenu'=>'atgpconnector_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/atgpconnector/pagelevel2.php',
		//							'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'$conf->atgpconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->atgpconnector->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->atgpconnector->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
...
/*
		$this->menu[$r]=array(
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuatgpconnector'),
			'mainmenu'=>'atgpconnector',
			'leftmenu'=>'',
			'url'=>'/atgpconnector/list.php',
			'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->atgpconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
			'perms'=>'$user->rights->atgpconnector->read',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2
		);
		$r++;
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=atgpconnector',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuatgpconnector'),
			'mainmenu'=>'atgpconnector',
			'leftmenu'=>'atgpconnector_left',
			'url'=>'/atgpconnector/list.php',
			'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->atgpconnector->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=atgpconnector,fk_leftmenu=atgpconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuatgpconnectorCreate'),
			'mainmenu'=>'atgpconnector',
			'leftmenu'=>'atgpconnector_left_create',
			'url'=>'/atgpconnector/card.php?action=create',
			'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->atgpconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=> '$user->rights->atgpconnector->write',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=atgpconnector,fk_leftmenu=atgpconnector_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuatgpconnectorList'),
			'mainmenu'=>'atgpconnector',
			'leftmenu'=>'atgpconnector_left_list',
			'url'=>'/atgpconnector/list.php',
			'langs'=>'atgpconnector@atgpconnector',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->atgpconnector->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
*/
	...
	function _addCronjobs()
	{
		...
		foreach($this->_cronjobs as $TPlannedCronjob)
		{
			...
			$cronjobs->fetchAll('DESC', 't.rowid', 0, 0, -1, $TFilter);
